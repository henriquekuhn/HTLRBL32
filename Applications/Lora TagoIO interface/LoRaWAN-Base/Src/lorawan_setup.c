...
static char regions[10][6] = {"AS923","AU915","CN470","CN77a9","EU433","EU868","KR920","IN865","US915","RU864"};
/*!
...
//	printf("===============================================================================\n");
	...
	if ( LORA_JoinStatus () != LORA_SET)
  {
	...
	//yappData->BuffSize = strlen((const char*)appData->Buff);
